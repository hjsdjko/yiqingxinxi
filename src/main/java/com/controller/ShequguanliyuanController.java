    ...
    */
    ...
    public R save(@RequestBody ShequguanliyuanEntity shequguanliyuan, HttpServletRequest request){
        ...
        Wrapper<ShequguanliyuanEntity> queryWrapper = new EntityWrapper<ShequguanliyuanEntity>()
            ...
            .or()
            .eq("shequguanliyuan_id_number", shequguanliyuan.getShequguanliyuanIdNumber())
            ;
        ...
        if(shequguanliyuanEntity==null){
            ...
            return R.error(511,"账户或者社区管理员手机号或者社区管理员身份证号已经被使用");
        }
    }
...
//                            shequguanliyuanEntity.setShequguanliyuanIdNumber(data.get(0));                    //社区管理员身份证号 要改的
//                            shequguanliyuanEntity.setShequguanliyuanPhoto("");//详情和图片
//                            shequguanliyuanEntity.setSexTypes(Integer.valueOf(data.get(0)));   //性别 要改的
//                            shequguanliyuanEntity.setZhiweiTypes(Integer.valueOf(data.get(0)));   //职位 要改的
//                            shequguanliyuanEntity.setShequTypes(Integer.valueOf(data.get(0)));   //所属社区 要改的
//                            shequguanliyuanEntity.setShequguanliyuanEmail(data.get(0));                    //电子邮箱 要改的
//                            shequguanliyuanEntity.setCreateTime(date);//时间
                            ...
                            //把要查询是否重复的字段放入map中
                                ...
                                //社区管理员身份证号
                                if(seachFields.containsKey("shequguanliyuanIdNumber")){
                                    List<String> shequguanliyuanIdNumber = seachFields.get("shequguanliyuanIdNumber");
                                    shequguanliyuanIdNumber.add(data.get(0));//要改的
                                }else{
                                    List<String> shequguanliyuanIdNumber = new ArrayList<>();
                                    shequguanliyuanIdNumber.add(data.get(0));//要改的
                                    seachFields.put("shequguanliyuanIdNumber",shequguanliyuanIdNumber);
                                }
                        }
                        ...
                        if(shequguanliyuanEntities_shequguanliyuanPhone.size() >0 ){
                         ...
                         //社区管理员身份证号
                        List<ShequguanliyuanEntity> shequguanliyuanEntities_shequguanliyuanIdNumber = shequguanliyuanService.selectList(new EntityWrapper<ShequguanliyuanEntity>().in("shequguanliyuan_id_number", seachFields.get("shequguanliyuanIdNumber")));
                        if(shequguanliyuanEntities_shequguanliyuanIdNumber.size() >0 ){
                            ArrayList<String> repeatFields = new ArrayList<>();
                            for(ShequguanliyuanEntity s:shequguanliyuanEntities_shequguanliyuanIdNumber){
                                repeatFields.add(s.getShequguanliyuanIdNumber());
                            }
                            return R.error(511,"数据库的该表中的 [社区管理员身份证号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
...
//    	ValidatorUtils.validateEntity(user);
        ...
        ShequguanliyuanEntity shequguanliyuanEntity = shequguanliyuanService.selectOne(queryWrapper);
        if(shequguanliyuanEntity != null)
            return R.error("账户或者社区管理员手机号或者社区管理员身份证号已经被使用");
        shequguanliyuan.setCreateTime(new Date());
        shequguanliyuanService.insert(shequguanliyuan);
        return R.ok();
    }
